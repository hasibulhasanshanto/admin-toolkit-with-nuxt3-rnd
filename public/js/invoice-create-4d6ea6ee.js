import{f as r}from"./app-b4670975.js";/* empty css            */const l=document.querySelector("#table-products"),o=document.querySelector("#btn-add-item"),n=document.querySelectorAll(".btn-remove-item"),i=`
  <tr>
    <td>
