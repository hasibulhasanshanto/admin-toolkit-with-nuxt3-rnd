                    ...
                    <div class="col-span-1 space-y-8 self-center md:col-span-2">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-1 flex-col gap-1">
                          ...
                          <div class="progress progress-success progress-sm" role="progressbar" aria-valuenow="10"
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-1 flex-col gap-1">
                          ...
                          <div class="progress progress-info progress-sm" role="progressbar" aria-valuenow="10"
                            aria-valuemin="0" aria-valuemax="100">
                            <div class="progress-line">
                              <div class="progress-line-track">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <div class="flex flex-1 flex-col gap-1">
                          ...
                          <div class="progress progress-warning progress-sm" role="progressbar" aria-valuenow="10"
                            aria-valuemin="0" aria-valuemax="100">
                            <div class="progress-line">
                              <div class="progress-line-track">
                ...
                <div class="card-body flex h-full flex-col">
                  ...
                  <div class="mt-auto divide-y dark:divide-slate-600">
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-success-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-up-right"></i>20%</span>
                    </div>
                    <!-- Opened  -->
                    <div class="flex items-center gap-4 py-2">
                      <div
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-success-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-up-right"></i>35%</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-danger-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-down-left"></i>10%</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-danger-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-down-left"></i>02%</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body flex h-full flex-col">
                  ...
                  <div class="mt-auto divide-y dark:divide-slate-600">
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-danger-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-down-left"></i>20%</span>
                    </div>
                    <!-- Direct Source  -->
                    <div class="flex items-center gap-4 py-2">
                      <div
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-success-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-up-right"></i>15%</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-success-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-up-right"></i>16%</span>
                    </div>
                    ...
                    <div class="flex items-center gap-4 py-2">
                      ...
                      <span class="ml-auto flex items-center text-sm font-medium text-danger-500"><i class="h-3 w-3"
                          stroke-width="3px" data-feather="arrow-down-left"></i>08%</span>
                    </div>
                  </div>
                </div>
              </div>
